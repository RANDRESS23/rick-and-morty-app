export default function FemaleSymbol () {
  return (
    <svg stroke='#c026d3' fill='#c026d3' viewBox='0 0 512 512' className='text-fuchsia-600' height='1em' width='1em' xmlns='http://www.w3.org/2000/svg'>
