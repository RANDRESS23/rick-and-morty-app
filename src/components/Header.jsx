    ...
    <div className='fixed w-full bg-light-primary h-14 shadow-lg shadow-light-blue-secondary'>
      <header className='container m-auto px-8 sm:px-20 flex justify-between items-center h-full'>
        ...
        <ul className='flex justify-center items-center gap-6'>
          ...
          <li>
            <BiMenu className='lg:hidden w-7 h-7 text-light-button-primary hover:text-light-blue-primary transition-all cursor-pointer' onClick={() => setShowNavBurger(true)} />
          </li>
        </ul>
      </header>
      <div className={`backdrop-blur-sm bg-light-button-secondary/20 w-full h-screen flex justify-end mt-[-56px] absolute transition duration-[.6s] ${showNavBurger ? 'translate-x-0' : 'translate-x-full'}`}>
        <ul className='bg-light-primary w-4/5 sm:w-80 lg:w-80'>
          <li className='px-4 py-3 flex justify-between items-center'>
            ...
            <AiOutlineClose className='w-7 h-7 text-light-button-primary hover:text-light-blue-primary transition-all cursor-pointer' onClick={() => setShowNavBurger(false)} />
          </li>
          <li className=''>
            <p className='text-lg text-light-button-primary bg-light-blue-secondary px-4 py-1 font-semibold cursor-default'>Home</p>
          </li>
        </ul>
      </div>
    </div>
