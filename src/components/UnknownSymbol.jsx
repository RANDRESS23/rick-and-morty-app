export default function UnknownSymbol () {
  return (
    <svg stroke='#4b5563' fill='#4b5563' viewBox='0 0 512 512' className='text-gray-600' height='1em' width='1em' xmlns='http://www.w3.org/2000/svg'>
