    ...
    <div className='h-screen w-full flex justify-center items-center pt-10'>
      <div className='w-9/12 h-[85%] bg-logo bg-no-repeat bg-center border shadow-2xl shadow-light-green-primary/40 rounded-lg flex flex-col justify-between'>
        ...
        <div className='flex flex-col lg:flex-row items-center px-6 lg:px-10'>
          <div className={`lg:absolute h-1/3 lg:h-[63%] lg:w-[30%] rounded-lg border mt-4 lg:pt-0 lg:${name.length > 27 ? 'mt-24' : 'mt-14'}`}>
          ...
          <div className='w-full lg:ml-[28rem] flex flex-col justify-between gap-3 lg:gap-7'>
            <div className='flex sm:grid sm:grid-cols-2 lg:flex flex-col gap-2 pt-4 lg:pt-0'>
